      ...
      <Portal.Root>
        ...
        <>
          ...
          <motion.div
            ...
            exit={open ? "open" : "close"}
            className={cn(
              "fixed top-[50%] left-[50%] z-50 grid w-full max-w-lg gap-4 bg-background p-6 shadow-lg sm:rounded-lg",
              className
            )}
          >
            {children}
            <DialogComponent.Close className="absolute top-4 right-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
