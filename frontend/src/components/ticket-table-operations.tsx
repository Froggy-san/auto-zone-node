  ...
  return (
    <div className="flex items-center gap-2">
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="max-h-[75vh] overflow-y-auto border-none sm:max-w-[425px]">
          <DialogHeader>
          ...
          <form action={handleSub} className="space-y-3">
            ...
            <div className="mt-4 flex flex-col-reverse gap-2">
              <DialogClose className="inline-flex h-8 items-center justify-center rounded-md bg-secondary px-3 text-xs font-medium whitespace-nowrap text-secondary-foreground shadow-sm transition-colors hover:bg-secondary/80 focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50">
                Cancel
                {/* <Button
                variant="secondary"
                size="sm"
