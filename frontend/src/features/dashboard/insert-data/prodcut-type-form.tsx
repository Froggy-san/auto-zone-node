...
import { createProductType, editProductType } from "@lib/services/product-types"
...
const ProductTypeForm = ({
  ...
  }, [selectedTab, externalImg, setExternalImg, setSelectedTab, remove, isNext])
  ...
  return (
    <Dialog open={diaOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent
        ref={containerRef}
        className="max-h-[76vh] max-w-[550px] gap-0 overflow-y-auto p-3 sm:p-6"
      >
        ...
        <Form {...form}>
          ...
          >
                  ...
                  <div className="flex items-start gap-2">
                    {relatedCategory && (
                      <FormItem className="mb-auto w-full">
                        ...
                        <FormControl>
                          <div className="pointer-events-none flex h-fit min-h-9 items-center gap-4 rounded-lg border p-1 text-xs">
            ...
            <div
              key="footer"
              className="flex items-center justify-between gap-2 border-t pt-4 select-none"
            >
              <AnimatePresence mode="wait">
                {!productTypeToEdit && (
                  <motion.div
              ...
              <div className="ml-auto flex flex-1 flex-row items-center justify-end gap-2 select-none">
                {!productTypeToEdit && (
                  <Button
                    onClick={() => {
                      if (isPrev) {
