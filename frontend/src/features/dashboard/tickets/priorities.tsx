  ...
  return (
    <div className="mt-10">
      ...
      {ticketCategories?.length ? (
        <div className="mx-auto my-10 flex max-h-[80vh] w-full max-w-[600px] flex-wrap gap-2 overflow-y-auto sm:max-h-80">
          {ticketCategories.map((category) => (
            <Priority key={category.id} priority={category.name} />
            // <Category
            //   key={category.id}
            //   category={category}
