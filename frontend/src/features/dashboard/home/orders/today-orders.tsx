...
const TodayOrders = () => {
  ...
  return (
    <div className="my-20">
      <h3 className="my-10 text-lg font-semibold sm:text-3xl">
        Today&apos;s Orders
      </h3>
      ...
      />
      <div className="max-h-[75vh] overflow-y-auto px-2 py-4 sm:px-3">
        {!isInitialLoading && !orders.length ? (
          <h4 className="py-4 text-center font-semibold">No Activities</h4>
        ) : (
          <>
